...
ACCESS_TOKEN_LIFETIME_MINUTES = env(
    'ACCESS_TOKEN_LIFETIME_MINUTES', default=5, cast=int)

REFRESH_TOKEN_LIFETIME_DAYS = env(
    'REFRESH_TOKEN_LIFETIME_DAYS', default=30, cast=int)
